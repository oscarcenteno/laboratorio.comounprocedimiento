...
using Laboratorio.Negocio.Ejercicio5.Inversiones;
using System;

namespace Laboratorio.Negocio.UnitTests.Ejercicio5
{
    [TestClass]
    public class GenereElRendimientoPorDescuento_Tests
    {
        ...
        public void GenereElRendimientoPorDescuento_ConTratamientoFiscal_LaFormula()
        {
            ...
            elResultadoObtenido = CalculosDeInversiones.GenereElRendimientoPorDescuentoRedondeado(
                elValorFacial,
                elValorTransadoNeto,
                laTasaDeImpuesto,
